return {
  ...
  config = function (_, opts)
    ...
    vim.keymap.set("n", "<leader>ha", function() harpoon:list():append() end, { desc = '[H]arpoon [a]ppend file' })
    vim.keymap.set('n', '<leader>hp', function () harpoon:list():prepend() end, { desc = '[H]arpoon [p]repend file' })
    ...
    vim.keymap.set("n", "<leader>hl", function() harpoon.ui:toggle_quick_menu(harpoon:list()) end, { desc = '[H]arpoon [l]ist popup'})
