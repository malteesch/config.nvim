...
local on_attach = function(_, bufnr)
  ...
  nnoremap('gi', function () require('trouble').open('lsp_implementations') end, bufopts, "Go to implementation")
  nnoremap('gr', function () require('trouble').open('lsp_references') end, bufopts, "Go to references")
