...
local on_attach = function(_, bufnr)
  ...
  nnoremap('gi', function () require('trouble').toggle('lsp_implementations') end, bufopts, "Go to implementation")
  nnoremap('gr', function () require('trouble').toggle('lsp_references') end, bufopts, "Go to references")
  ...
  vim.keymap.set('v', "<A-CR>", "<ESC><CMD>lua vim.lsp.buf.range_code_action()<CR>",
